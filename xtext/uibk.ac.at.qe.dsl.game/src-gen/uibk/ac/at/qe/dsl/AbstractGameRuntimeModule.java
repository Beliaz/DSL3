...
import uibk.ac.at.qe.dsl.generator.GameGenerator;
import uibk.ac.at.qe.dsl.parser.antlr.GameAntlrTokenFileProvider;
import uibk.ac.at.qe.dsl.parser.antlr.GameParser;
import uibk.ac.at.qe.dsl.parser.antlr.internal.InternalGameLexer;
import uibk.ac.at.qe.dsl.scoping.GameScopeProvider;
import uibk.ac.at.qe.dsl.serializer.GameSemanticSequencer;
import uibk.ac.at.qe.dsl.serializer.GameSyntacticSequencer;
import uibk.ac.at.qe.dsl.services.GameGrammarAccess;
import uibk.ac.at.qe.dsl.validation.GameValidator;
...
public abstract class AbstractGameRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "uibk/ac/at/qe/dsl/Game.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("uibk.ac.at.qe.dsl.Game");
	}
